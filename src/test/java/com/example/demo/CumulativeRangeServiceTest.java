...
public class CumulativeRangeServiceTest {
    ...
    public void testCalculateCumulativeRange_WithDiscountAmount() {
        ...
        assertEquals("ProductA", profilingRequest.getDiscountDetails().get(profilingRequest.getDiscountDetails().size() - 1).getProductConfigurationId());
        assertEquals(priceApplicationON - priceApplicationON*Double.parseDouble(range.getApplicationValue())/100, profilingRequest.getDiscountDetails().get(profilingRequest.getDiscountDetails().size() - 1).getAfterAdjustment());
    }
    ...
    public void testCalculateCumulativeRange_WithDiscountPercentage() {
        ...
        assertEquals(2, profilingRequest.getDiscountDetails().size());
        assertEquals("ProductA", profilingRequest.getDiscountDetails().get(profilingRequest.getDiscountDetails().size() - 1).getProductConfigurationId());
        assertEquals(priceApplicationON - Double.parseDouble(range.getApplicationValue()), profilingRequest.getDiscountDetails().get(profilingRequest.getDiscountDetails().size() - 1).getAfterAdjustment());
    }
    ...
    public void testCalculateCumulativeRange_NoMatchingTimeDimension() {
        ...
        assertEquals(priceApplicationON, profilingRequest.getDiscountDetails().get(profilingRequest.getDiscountDetails().size() - 1).getAfterAdjustment());
    }
    ...
    public void testCalculateCumulativeRange_WithMultipleRanges() {
        ...
        assertEquals(afterAdjustment2, profilingRequest.getDiscountDetails().get(profilingRequest.getDiscountDetails().size() - 1).getAfterAdjustment());
    }
