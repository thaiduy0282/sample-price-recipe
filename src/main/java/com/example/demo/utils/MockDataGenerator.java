...
public class MockDataGenerator {
    public static List<PriceRecipe> fetchAllRecipes() {
        ...
        recipes.add(new PriceRecipe(1L, "contract", "ae7ae002-dd1c-4e00-895f-6e0646f15196", "range", "Type1", "DealStrategy1", "ApplicationON1", "Execution1", "Condition1", "ApplicationType1", 100.0, "AppliedOn1", "PriceAppliedTo1", "Dimension1", new ArrayList<>()));
        recipes.add(new PriceRecipe(2L, "contract", "ae7ae002-dd1c-4e00-895f-6e0646f15196", "dealMax", "Type1", "DealStrategy1", "ApplicationON1", "Execution1", "Condition1", "ApplicationType1", 100.0, "AppliedOn1", "PriceAppliedTo1", "Dimension1", new ArrayList<>()));
        recipes.add(new PriceRecipe(3L, "contract", "ae7ae002-dd1c-4e00-895f-6e0646f15196", "range", "Type1", "DealStrategy1", "ApplicationON1", "Execution1", "Condition1", "ApplicationType1", 100.0, "AppliedOn1", "PriceAppliedTo1", "Dimension1", new ArrayList<>()));
        recipes.add(new PriceRecipe(4L, "quote", "ae7ae002-dd1c-4e00-895f-111111111111", "range", "Type1", "DealStrategy1", "ApplicationON1", "Execution1", "Condition1", "ApplicationType1", 100.0, "AppliedOn1", "PriceAppliedTo1", "Dimension1", new ArrayList<>()));
...
//
//        lineItems.add(new LineItem(1L, "Model A", "Daily", "Tag1", "Category1", "Family1", 45.67, "Config1", "Location1", 1));
